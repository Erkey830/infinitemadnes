...
{
    [CONTEST_EFFECT_HIGHLY_APPEALING]                      = COMPOUND_STRING("Un movimiento muy atractivo."),
[CONTEST_EFFECT_USER_MORE_EASILY_STARTLED]             = COMPOUND_STRING("Después de este movimiento, el\nusuario es más fácilmente sobresaltado."),
[CONTEST_EFFECT_GREAT_APPEAL_BUT_NO_MORE_MOVES]        = COMPOUND_STRING("Hace un gran apego, pero\nno permite más movimientos hasta el final."),
[CONTEST_EFFECT_REPETITION_NOT_BORING]                 = COMPOUND_STRING("Puede ser usado repetidamente\nsin aburrir al JUEZ."),
[CONTEST_EFFECT_AVOID_STARTLE_ONCE]                    = COMPOUND_STRING("Puede evitar ser sobresaltado\npor otros una vez."),
[CONTEST_EFFECT_AVOID_STARTLE]                         = COMPOUND_STRING("Puede evitar ser sobresaltado\npor otros."),
[CONTEST_EFFECT_AVOID_STARTLE_SLIGHTLY]                = COMPOUND_STRING("Puede evitar ser sobresaltado\npor otros un poco."),
[CONTEST_EFFECT_USER_LESS_EASILY_STARTLED]             = COMPOUND_STRING("Después de este movimiento, el\nusuario es menos propenso a ser sobresaltado."),
[CONTEST_EFFECT_STARTLE_FRONT_MON]                     = COMPOUND_STRING("Sobresalta ligeramente al\nPOKÉMON de enfrente."),
[CONTEST_EFFECT_SLIGHTLY_STARTLE_PREV_MONS]            = COMPOUND_STRING("Sobresalta ligeramente a aquellos\nque han hecho apegos."),
[CONTEST_EFFECT_STARTLE_PREV_MON]                      = COMPOUND_STRING("Sobresalta al POKÉMON que\napeló antes que el usuario."),
[CONTEST_EFFECT_STARTLE_PREV_MONS]                     = COMPOUND_STRING("Sobresalta a todos los POKÉMON que\nhan hecho sus apegos."),
[CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON]               = COMPOUND_STRING("Sobresalta gravemente al\nPOKÉMON de enfrente."),
[CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS]               = COMPOUND_STRING("Sobresalta gravemente a aquellos que\nhan hecho apegos."),
[CONTEST_EFFECT_STARTLE_PREV_MON_2]                    = COMPOUND_STRING("Sobresalta al POKÉMON que\napeló antes que el usuario."),
[CONTEST_EFFECT_STARTLE_PREV_MONS_2]                   = COMPOUND_STRING("Sobresalta a todos los POKÉMON que\nhan hecho sus apegos."),
[CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION]                 = COMPOUND_STRING("Cambia la atención del JUEZ\nde los otros."),
[CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION]     = COMPOUND_STRING("Sobresalta al POKÉMON que\ntiene la atención del JUEZ."),
[CONTEST_EFFECT_JAMS_OTHERS_BUT_MISS_ONE_TURN]         = COMPOUND_STRING("Sobresalta a los otros, y pierde\nun turno de apegos."),
[CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL]         = COMPOUND_STRING("Sobresalta a los POKÉMON que\nhicieron un apego del mismo tipo."),
[CONTEST_EFFECT_STARTLE_MONS_COOL_APPEAL]              = COMPOUND_STRING("Sobresalta gravemente a los POKÉMON\nque hicieron apegos de CARISMA."),
[CONTEST_EFFECT_STARTLE_MONS_BEAUTY_APPEAL]            = COMPOUND_STRING("Sobresalta gravemente a los POKÉMON\nque hicieron apegos de BELLEZA."),
[CONTEST_EFFECT_STARTLE_MONS_CUTE_APPEAL]              = COMPOUND_STRING("Sobresalta gravemente a los POKÉMON\nque hicieron apegos de DULZURA."),
[CONTEST_EFFECT_STARTLE_MONS_SMART_APPEAL]             = COMPOUND_STRING("Sobresalta gravemente a los POKÉMON\nque hicieron apegos de INGENIO."),
[CONTEST_EFFECT_STARTLE_MONS_TOUGH_APPEAL]             = COMPOUND_STRING("Sobresalta gravemente a los POKÉMON\nque hicieron apegos de DUREZA."),
[CONTEST_EFFECT_MAKE_FOLLOWING_MON_NERVOUS]            = COMPOUND_STRING("Hace que un POKÉMON después\ndel usuario se ponga nervioso."),
[CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS]           = COMPOUND_STRING("Hace que todos los POKÉMON después\ndel usuario se pongan nerviosos."),
[CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS]         = COMPOUND_STRING("Empeora la condición de\nlos que han hecho apegos."),
[CONTEST_EFFECT_BADLY_STARTLES_MONS_IN_GOOD_CONDITION] = COMPOUND_STRING("Sobresalta gravemente a los POKÉMON\nen buena condición."),
[CONTEST_EFFECT_BETTER_IF_FIRST]                       = COMPOUND_STRING("El apego funciona mejor si\nse realiza primero."),
[CONTEST_EFFECT_BETTER_IF_LAST]                        = COMPOUND_STRING("El apego funciona mejor si\nse realiza último."),
[CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONES]           = COMPOUND_STRING("Hace el apego tan bueno\ncomo los anteriores."),
[CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONE]            = COMPOUND_STRING("Hace el apego tan bueno\ncomo el anterior."),
[CONTEST_EFFECT_BETTER_WHEN_LATER]                     = COMPOUND_STRING("El apego funciona mejor\ncuanto más tarde se realiza."),
[CONTEST_EFFECT_QUALITY_DEPENDS_ON_TIMING]             = COMPOUND_STRING("La calidad del apego varía\ndependiendo del momento."),
[CONTEST_EFFECT_BETTER_IF_SAME_TYPE]                   = COMPOUND_STRING("Funciona bien si es del mismo\ntipo que el anterior."),
[CONTEST_EFFECT_BETTER_IF_DIFF_TYPE]                   = COMPOUND_STRING("Funciona bien si es de un tipo\ndiferente al anterior."),
[CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL]               = COMPOUND_STRING("Afectado por lo bien que\nfue el apego anterior."),
[CONTEST_EFFECT_IMPROVE_CONDITION_PREVENT_NERVOUSNESS] = COMPOUND_STRING("Mejora la condición del usuario.\nAyuda a prevenir el nerviosismo."),
[CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION]            = COMPOUND_STRING("El apego funciona bien si la\ncondición del usuario es buena."),
[CONTEST_EFFECT_NEXT_APPEAL_EARLIER]                   = COMPOUND_STRING("El siguiente apego puede\nhacerse más temprano el próximo turno."),
[CONTEST_EFFECT_NEXT_APPEAL_LATER]                     = COMPOUND_STRING("El siguiente apego puede\nhacerse más tarde el próximo turno."),
[CONTEST_EFFECT_MAKE_SCRAMBLING_TURN_ORDER_EASIER]     = COMPOUND_STRING("Hace que el orden del próximo turno\nsea más fácil de alterar."),
[CONTEST_EFFECT_SCRAMBLE_NEXT_TURN_ORDER]              = COMPOUND_STRING("Altera el orden de los apegos\nen el próximo turno."),
[CONTEST_EFFECT_EXCITE_AUDIENCE_IN_ANY_CONTEST]        = COMPOUND_STRING("Un apego que entusiasma al\npúblico en cualquier CONCURSO."),
[CONTEST_EFFECT_BADLY_STARTLE_MONS_WITH_GOOD_APPEALS]  = COMPOUND_STRING("Sobresalta gravemente a todos los POKÉMON\nque hicieron buenos apegos."),
[CONTEST_EFFECT_BETTER_WHEN_AUDIENCE_EXCITED]          = COMPOUND_STRING("El apego funciona mejor cuanto\nmás entusiasmada esté la multitud."),
[CONTEST_EFFECT_DONT_EXCITE_AUDIENCE]                  = COMPOUND_STRING("Evita temporalmente que la\nmultitud se entusiasme.")
...
const u8 *const gContestMoveTypeTextPointers[] =
{
    ...
    [CONTEST_CATEGORY_SMART]  = COMPOUND_STRING("INGENIO"),
...
{
    [CONTEST_CATEGORY_COOL]    = COMPOUND_STRING("Movimiento CARISMA"),
    [CONTEST_CATEGORY_BEAUTY]  = COMPOUND_STRING("Movimiento BELLEZA"),
    [CONTEST_CATEGORY_CUTE]    = COMPOUND_STRING("Movimiento DULZURA"),
    [CONTEST_CATEGORY_SMART]   = COMPOUND_STRING("Movimiento INGENIO"),
    [CONTEST_CATEGORY_TOUGH]   = COMPOUND_STRING("Movimiento DUREZA"),
...
{
    COMPOUND_STRING("{STR_VAR_1} no logró\nsobresalir en absoluto…{PAUSE_UNTIL_PRESS}"),
    COMPOUND_STRING("{STR_VAR_1} no logró\nsobresalir mucho…{PAUSE_UNTIL_PRESS}"),
    COMPOUND_STRING("{STR_VAR_1} llamó un\npoco la atención.{PAUSE_UNTIL_PRESS}"),
    COMPOUND_STRING("{STR_VAR_1} atrajo\nmucha atención.{PAUSE_UNTIL_PRESS}"),
    COMPOUND_STRING("{STR_VAR_1} comandó\nla atención total.{PAUSE_UNTIL_PRESS}"),
    COMPOUND_STRING("{STR_VAR_1} no ha hecho\nsu apelo.{PAUSE_UNTIL_PRESS}"),
};
