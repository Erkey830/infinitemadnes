...
const u8 *const gNatureNamePointers[NUM_NATURES] =
{
    ...
    [NATURE_LONELY] = COMPOUND_STRING("Huraña"),
    [NATURE_BRAVE] = COMPOUND_STRING("Audaz"),
    [NATURE_ADAMANT] = COMPOUND_STRING("Firme"),
    [NATURE_NAUGHTY] = COMPOUND_STRING("Pícara"),
    [NATURE_BOLD] = COMPOUND_STRING("Osada"),
    [NATURE_DOCILE] = COMPOUND_STRING("Dócil"),
    [NATURE_RELAXED] = COMPOUND_STRING("Plácida"),
    [NATURE_IMPISH] = COMPOUND_STRING("Agitada"),
    [NATURE_LAX] = COMPOUND_STRING("Floja"),
    [NATURE_TIMID] = COMPOUND_STRING("Miedosa"),
    [NATURE_HASTY] = COMPOUND_STRING("Activa"),
    [NATURE_SERIOUS] = COMPOUND_STRING("Seria"),
    [NATURE_JOLLY] = COMPOUND_STRING("Alegre"),
    [NATURE_NAIVE] = COMPOUND_STRING("Ingenua"),
    [NATURE_MODEST] = COMPOUND_STRING("Modesta"),
    [NATURE_MILD] = COMPOUND_STRING("Afable"),
    [NATURE_QUIET] = COMPOUND_STRING("Mansa"),
    [NATURE_BASHFUL] = COMPOUND_STRING("Tímida"),
    [NATURE_RASH] = COMPOUND_STRING("Alocada"),
    [NATURE_CALM] = COMPOUND_STRING("Serena"),
    [NATURE_GENTLE] = COMPOUND_STRING("Amable"),
    [NATURE_SASSY] = COMPOUND_STRING("Grosera"),
    [NATURE_CAREFUL] = COMPOUND_STRING("Cauta"),
    [NATURE_QUIRKY] = COMPOUND_STRING("Rara"),
};
